...
public class GenerateQuery {
        ...
        if (possibleCoverQ.size() > 0) {
            ...
            for (int i = 0; i < possibleCoverQ.size(); i++) {
                ...
                if (RunTimeConfig.removeStopWordsInCQ) {
                    return cQuery;
                } else if (tokenizer.TokenizeText(cQuery.getQuery_text()).size() == 1) {
                    return cQuery;
                }
            }
        }
    ...
    private String getUniGramFromLM(int bucket_num, Topic coverQueryTopic) {
        ...
        if (possibleCoverQ.size() > 0) {
            ...
            } else if (tokenizer.TokenizeText(possibleCoverQ.get(coverQNum)).size() == 1) {
                return possibleCoverQ.get(coverQNum);
            }
        }
        return null;
    ...
    public UserQuery getCQfromBigramLM(int bucket_num, TopicTreeNode cover_node, UserQuery currentQuery, Profile profile) {
        ...
        if (possibleCoverQ.size() > 0) {
            ...
            for (int i = 0; i < possibleCoverQ.size(); i++) {
                ...
                if (RunTimeConfig.removeStopWordsInCQ) {
                    return cQuery;
                } else if (tokenizer.TokenizeText(cQuery.getQuery_text()).size() == 2) {
                    return cQuery;
                }
            }
        }
    ...
    private String getCQfromBigramLM(int bucket_num, Topic coverQueryTopic, String unigram) {
        ...
        if (possibleCoverQ.size() > 0) {
            ...
            if (RunTimeConfig.removeStopWordsInCQ) {
                return possibleCoverQ.get(coverQNum);
            } else if (tokenizer.TokenizeText(possibleCoverQ.get(coverQNum)).size() == 2) {
                return possibleCoverQ.get(coverQNum);
            }
        }
        return null;
